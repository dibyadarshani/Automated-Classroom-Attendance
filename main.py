...
labelback=Label(window,image=back)
labelback.pack()
...
def err_screen():
    ...
    Button(sc1,text='OK',command=del_sc1,fg="black"  ,bg="#D3D3D3"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def err_screen1():
    ...
    Button(sc2,text='OK',command=del_sc2,fg="black"  ,bg="#D3D3D3"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('StudentsDetails\StudentDetails.csv', 'a+') as csvFile:
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("StudentsDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'password':
                ...
                cs = 'StudentsDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        ...
        l='please make "TrainingImages" folder'
        Notification.configure(text=l, bg="#D3D3D3", width=50, font=('times', 18, 'bold'))
    ...
    try:
        ...
        Notification.configure(text=q, bg="#D3D3D3", width=50, font=('times', 18, 'bold'))
        Notification.place(x=350, y=400)
...
message = tk.Label(window, text="Attendance-Management-System",border=0,font=('times', 30, 'italic bold '))

message.place(x=380, y=10)

Notification = tk.Label(window, text="All things good", bg="Green", fg="white", width=15,
                      height=3, font=('times', 17, 'bold'))

lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="black", bg="#c0c0c0", font=('times', 15, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="white", fg="#2c403e", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="#c0c0c0", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="#2c403e", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="#c774b5"  ,width=10  ,height=1 ,bd=5,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="#c774b5"  ,width=10 ,height=1,bd=5, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

  

takeImg = tk.Button(window,text="Register",command=take_img,bg="#c774b5",width=20 ,height=3,bd=5, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=150, y=500)


trainImg = tk.Button(window,text="Train the model",command=trainimg,bg="#c774b5",width=20 ,height=3,bd=5, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=525, y=500)

FA = tk.Button(window,text="Take Attendance",command=subjectchoose,bg="#c774b5",width=20 ,height=3,bd=5, activebackground = "Red" ,font=('times', 15, ' bold '))
